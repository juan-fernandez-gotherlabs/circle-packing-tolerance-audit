...
An earlier version of the reproducibility artifact is archived at Zenodo
\cite{artifact}; the repository cited in Section~\ref{sec:repro} contains the
current certificate and reports.  The public numerical table currently
...
matching author certificate as the \emph{best independently verified witness
in the manifested corpus}.  The unqualified phrase ``best-known'' would be
...
a neighborhood of $x^*$.  Set $F(z)=f(g^{-1}(z))$.  From
\eqref{eq:kkt},
\[
  \nabla_zF(0)=J(x^*)^{-T}\nabla f(x^*)=-\lambda.
\]
...
The earlier version 1.1.0 audit release is archived as DOI
\href{https://doi.org/10.5281/zenodo.21853178}{10.5281/zenodo.21853178}.  The
current interval certificate and preprint will require a new versioned archive
...
\href{https://doi.org/10.5281/zenodo.21853178}{doi:10.5281/zenodo.21853178}.
